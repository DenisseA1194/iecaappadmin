...
//    datos de aviso e imagen
    ...
    var body: some View {
        NavigationView {
            Form {
                Section(header: Text("Selecciona un área")) {
                    Picker("Areas", selection: $seleccionArea) {
                        ...
                        if index != 0 {
                            ...
                            _Nombre = areaSeleccionada.Nombre
                            _Notas = areaSeleccionada.Notas
                            _Id = areaSeleccionada.Id
                        ...
                        ToolbarItem(placement: .navigationBarTrailing) {
                            Button(action: {
                                ...
                                Alert(title: Text("Aviso"), message: Text("Agrega una nueva área"), dismissButton: .default(Text("Aceptar")))
                            }
                        }
                    }
                }
                    ...
                    Button(action: {
                        if todosLosCamposEstanCompletos() {
                            if buttonText == "Agregar"{
                                ...
                                viewModelArea.agregarNuevaArea(nuevaArea: nuevaArea)
                                viewModelArea.fetchAreas()
                            }else{
                                ...
                                viewModelArea.editarArea(area: area)
                                viewModelArea.fetchAreas()
                            }
                        }else{
