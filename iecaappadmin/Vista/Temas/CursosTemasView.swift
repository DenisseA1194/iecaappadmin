...
//    }
    ...
    var body: some View {
        NavigationStack{
            ...
            Spacer()
            VStack{
                Section(header: Text("Selecciona una curso") .frame(maxWidth: .infinity, alignment: .leading)) {
                ...
                Section(header: Text("Selecciona un tema") .frame(maxWidth: .infinity, alignment: .leading)) {
